...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <form class="center" method="post">
        <ul class="FormUl">
            ...
            <li>Password:</li>
            <li><input value="<%=pw %>" type="password" name="pw" placeholder="Enter password" oninput="document.getElementById('Checkpw').setCustomValidity(this.value !== document.getElementById('Checkpw').value ? 'Passwords do not match' : '');" pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[^\w\d\s]).{8,50}$" title="Have capital and non capital English letters, numbers, punctuation and between 8-50 characters" id="pword" required /></li>
